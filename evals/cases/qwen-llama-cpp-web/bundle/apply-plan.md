...
Bundle: `evals/cases/qwen-llama-cpp-web/bundle`
...
- `wiki/concepts/gguf-model-format.md` — create new page.
- `wiki/concepts/jinja-chat-template.md` — create new page.
- `wiki/topics/local-qwen-llama-cpp-inference.md` — create new page.
