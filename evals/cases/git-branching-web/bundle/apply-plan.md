...
Bundle: `evals/cases/git-branching-web/bundle`
...
- `wiki/sources/git-branches-in-a-nutshell.md` — create new page.
- `wiki/concepts/git-branch.md` — create new page.
- `wiki/concepts/git-head.md` — create new page.
- `wiki/topics/git-branching-model.md` — create new page.
