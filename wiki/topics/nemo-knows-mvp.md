...
The first usable loop is ingest -> query -> file useful answers back into the wiki. This implements the [[llm-wiki-core-concept]] at a small local scale.
...
Useful query answers can then be filed back as topic pages, making the wiki a [[wiki-as-compounding-artifact]].
